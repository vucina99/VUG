...
$GLOBALS['VUG_ICONS'] = [
    ...
    'lightning-charge-fill' => '<path d="M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09z"/>',
    ...
    'x-lg' => '<path d="M1.293 1.293a1 1 0 0 1 1.414 0L8 6.586l5.293-5.293a1 1 0 1 1 1.414 1.414L9.414 8l5.293 5.293a1 1 0 0 1-1.414 1.414L8 9.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L6.586 8 1.293 2.707a1 1 0 0 1 0-1.414"/>',
    ...
    // Dodato za portfolio (stranice projekata): TikTok kanal, play bedž na reels
    // vizualima i globus u "browser" traci web projekata.
    ...
    'play-fill' => '<path d="M5 3.3v9.4a.5.5 0 0 0 .76.43l7.5-4.7a.5.5 0 0 0 0-.86l-7.5-4.7A.5.5 0 0 0 5 3.3"/>',
    'globe' => '<circle cx="8" cy="8" r="6.6" fill="none" stroke="currentColor" stroke-width="1.25"/><ellipse cx="8" cy="8" rx="2.9" ry="6.6" fill="none" stroke="currentColor" stroke-width="1.25"/><path d="M1.8 5.9h12.4M1.8 10.1h12.4" fill="none" stroke="currentColor" stroke-width="1.25"/>',
];
